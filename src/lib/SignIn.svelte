			...
			>
				...
				{#if rememberMe || lostPassword}
					<div class="flex items-start">
						...
						{/if}
						{#if lostPassword}
							<A href={lostPasswordLink} class="ml-auto text-sm"
								>Lost Password?</A
							>
						{/if}
					</div>
...
## Type
[SingInProps](https://github.com/themesberg/flowbite-svelte-admin-dashboard/blob/main/src/lib/types.ts#L299)
## Props
@prop children
