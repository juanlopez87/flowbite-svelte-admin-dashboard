...
<Card size="xl" class="p-4 sm:p-6">
	<div class="mb-4 flex items-center gap-2">
		...
		<Popover placement="bottom-start">
			<div
				class="w-72 space-y-2 text-sm font-normal text-gray-500 dark:text-gray-300"
			>
	...
	<Tabs
		style="full"
		class="flex divide-x divide-gray-200 shadow rtl:divide-x-reverse dark:divide-gray-700"
