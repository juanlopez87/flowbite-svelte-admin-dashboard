			...
			<Li class="py-4">
				<div class="flex items-center space-x-4">
					...
					<div class="min-w-0 flex-1">
						...
						<p
							class="truncate text-sm font-normal text-gray-500 dark:text-gray-300"
						>
							{device}
						</p>
					</div>
					{#if btnName}
						<Button
							{href}
							class="px-3 py-2 dark:text-gray-300 dark:hover:text-white"
							color="light">{btnName}</Button
						>
					{/if}
				</div>
			</Li>
