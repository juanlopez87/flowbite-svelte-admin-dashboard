...
<div class="mx-auto mb-24 max-w-7xl p-8">
	...
	<CodeWrapper class="my-8" innerClass="flex justify-center">
		<ExampleComponents.DeleteDrawer />
		{#snippet codeblock()}
			<HighlightCompo
				codeLang="ts"
				code={exampleModules['./examples/DeleteDrawerEx.svelte'] as string}
			/>
		{/snippet}
	</CodeWrapper>
	...
	<CodeWrapper class="my-8" innerClass="flex justify-center">
		...
		{#snippet codeblock()}
			<HighlightCompo
				codeLang="ts"
				code={exampleModules['./examples/DeleteModalEx.svelte'] as string}
			/>
		{/snippet}
	</CodeWrapper>
	...
	<CodeWrapper class="my-8" innerClass="flex justify-center">
		...
		{#snippet codeblock()}
			<HighlightCompo
				codeLang="ts"
				code={exampleModules['./examples/ProductDrawerEx.svelte'] as string}
			/>
		{/snippet}
	</CodeWrapper>
	...
	<CodeWrapper class="my-8" innerClass="flex justify-center">
		<ExampleComponents.UserModal />
		{#snippet codeblock()}
			<HighlightCompo
				codeLang="ts"
				code={exampleModules['./examples/UserModalEx.svelte'] as string}
			/>
		{/snippet}
	</CodeWrapper>
