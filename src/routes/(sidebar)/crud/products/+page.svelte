<script lang="ts">
	...
	const description: string =
		'CRUD products examaple - Flowbite Svelte Admin Dashboard';
			...
			{#snippet end()}
				<div class="space-x-2">
					<Button
						...
						onclick={() => toggle(ProductDrawer)}>Add new product</Button
					>
				</div>
			{/snippet}
		</Toolbar>
				...
				<TableBodyRow class="text-base">
					...
					<TableBodyCell class="space-x-2">
						...
						<Button
							...
							size="sm"
							class="gap-2 px-3"
							onclick={() => toggle(DeleteDrawer as Component)}
						>
