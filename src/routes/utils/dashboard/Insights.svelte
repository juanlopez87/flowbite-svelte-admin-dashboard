	...
	<Carousel images={items} class="flex h-full">
		{#snippet slide({ index })}
			{#if index == 0}
				...
				>
					<div
						class="text-primary-600 mb-4 flex items-center gap-2 text-lg font-medium"
					>
					...
					<ul
						class="mb-4 list-disc space-y-3 pl-4 text-gray-500 dark:text-gray-300"
					>
						<li>
			...
			{:else if index == 1}
				...
				>
					...
					<ul
						role="list"
						class="mb-4 list-disc space-y-3 pl-2 text-gray-500 dark:text-gray-300"
					>
					...
					<a
						href="#top"
						class="text-primary-700 dark:text-primary-500 inline-flex items-center rounded-lg p-2 font-medium hover:bg-gray-100 dark:hover:bg-gray-700"
					>
			...
			{:else}
				...
				>
					<div
						class="mb-4 flex items-center text-lg font-medium text-purple-600"
					>
