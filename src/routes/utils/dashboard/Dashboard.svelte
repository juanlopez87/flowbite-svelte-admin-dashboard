		...
		<ActivityList title="Latest Activity">
			...
			<Timeline>
				<TimelineItem title="Application UI design in Figma" date="April 2025">
					<p
						class="mb-4 text-base font-normal text-gray-500 dark:text-gray-300"
					>
					...
					<Button color="alternative"
						>Learn more<ArrowRightOutline class="ms-2" size="sm" /></Button
					>
				</TimelineItem>
				<TimelineItem title="Marketing UI code in Flowbite" date="March 2025">
					...
					<a
						href="#top"
						class="text-primary-700 dark:text-primary-500 inline-flex items-center text-xs font-medium hover:underline sm:text-sm"
					>
