		...
		<div class="items-center justify-between gap-3 space-y-4 sm:flex sm:space-y-0">
			<div class="flex items-center">
				...
				<Dropdown simple class="w-48 space-y-2 text-sm" placement="bottom-start">
					...
					>
					<DropdownItem
						><Checkbox checked>Cancelled (56)</Checkbox></DropdownItem
					>
					<DropdownItem
					...
					>
					<DropdownItem
						><Checkbox checked>In review (97)</Checkbox></DropdownItem
					>
				</Dropdown>
			</div>
	...
	>
		<TableHead class="bg-gray-50 dark:bg-gray-700">
			{#each headers as header}
				<TableHeadCell class="p-4 font-normal whitespace-nowrap"
