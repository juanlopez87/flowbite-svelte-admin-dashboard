	...
	<form class="overflow-y-auto lg:max-h-[60rem] 2xl:max-h-fit">
		...
		>
			<p>
				...
				to gather everyone involved in the design project. Let me know about your availability
				in the thread.
			</p>
		...
		>
			<p>Hello everyone,</p>
			<p>
				Thank you for the workshop, it was very productive meeting. I can't wait
				to start working on this new project with you guys. But first things
				first, I'am waiting for the offer and pitch deck from you. It would be
		...
		>
			...
			<div class="items-center 2xl:flex 2xl:space-x-4">
				...
				>
					...
					<div
						class="ml-auto flex items-center text-gray-500 dark:text-gray-300"
					>
						<ToolbarButton class="rounded">
							<DownloadOutline size="lg" /><span class="sr-only"
								>Download</span
							>
						</ToolbarButton>
						<ToolbarButton class="rounded">
