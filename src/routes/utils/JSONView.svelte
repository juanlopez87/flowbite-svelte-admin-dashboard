...
<div
	class="json-view my-2 mb-8 overflow-hidden rounded-md border border-gray-200 bg-gray-50"
>
	<button
		onclick={toggle}
		class="toggle-btn flex w-full items-center justify-between p-3 text-left transition-colors hover:bg-gray-100"
	>
			...
			{:else}
				<div class="p-2">
					{#each data.props as propArray}
						<div
							class="prop-item flex rounded p-1.5 text-sm hover:bg-gray-100"
						>
							<div class="prop-name flex-grow font-mono text-violet-700">
								{propArray[0]}
							</div>
