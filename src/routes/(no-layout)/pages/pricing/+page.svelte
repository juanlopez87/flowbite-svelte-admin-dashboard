...
<main class="mx-auto bg-gray-50 dark:bg-gray-900">
	<div class="container mx-auto px-4 pt-24 md:pt-32 lg:px-0 dark:bg-gray-900">
		...
		<section
			class="grid grid-cols-1 space-y-12 pt-9 md:grid-cols-2 md:gap-6 md:space-y-0 md:gap-x-6 lg:grid-cols-3"
		>
...
<Footer {menus} {brand}>
	{#snippet description()}
		<P
			>Flowbite is a UI library of elements &amp; components based on Tailwind CSS
			that can get you started building websites faster and more efficiently.</P
		>
	{/snippet}
</Footer>
